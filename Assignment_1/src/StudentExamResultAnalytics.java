...
public class StudentExamResultAnalytics {
    ...
    public static void main(String[] args) {
        ...
        List<Student> students = Arrays.asList(
                new Student(101, "Sheela", "Java", 82, true),
                new Student(102, "Bharathi", "Java", 45, false),
                new Student(103, "Rachel", "Python", 91, true),
                new Student(104, "Deepa", "Java", 67, true),
                new Student(105, "Leah", "Python", 38, false),
                new Student(106, "Niti", "DevOps", 74, true),
                new Student(107, "Geetha", "DevOps", 88, true),
                new Student(108, "Hannah", "Java", 53, true),
                new Student(109, "Amelia", "Python", 79, true),
                new Student(110, "Joan", "DevOps", 62, true),
                new Student(111, "Ramya", "Java", 95, true),
                new Student(112, "Pavithra", "Python", 49, false)
        );
